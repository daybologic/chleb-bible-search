...
For API documentation, please use the documentation published at [SwaggerHub](https://app.swaggerhub.com/apis/M6KVM/chleb-bible-search/2.3.1)
...
The latest release is version 2.3.1, which is available for download at the following sites:

  * [GitHub](https://github.com/daybologic/chleb-bible-search/archive/refs/tags/v2.3.1.tar.gz)
  * [SourceHut](https://git.sr.ht/~m6kvm/chleb-bible-search/archive/v2.3.1.tar.gz)

The latest release is available as a Debian package from the following locations:

  * [GitHub](https://github.com/daybologic/chleb-bible-search/releases/download/v2.3.1/chleb-bible-search_2.3.1_all.deb)
  * [SourceHut](https://git.sr.ht/~m6kvm/chleb-bible-search/refs/v2.3.1)
...
```
sudo dpkg -i \
	chleb-bible-search_2.3.1_all.deb
	chleb-bible-search-core_2.3.1_all.deb
	chleb-bible-search-dict_2.3.1_all.deb
...
These files are a all bash shell files.  Start with [data/tests/1/template.sh](https://git.sr.ht/~m6kvm/chleb-bible-search/tree/v2.3.1/item/data/tests/1/template.sh) and copy this. The digit at the start represents the endpoint version.

You can test this by running [bin/maint/run-functional-tests.sh](https://git.sr.ht/~m6kvm/chleb-bible-search/tree/v2.3.1/item/bin/maint/run-functional-tests.sh) and specify the 1/name or run all the tests by specifying no parameters.
