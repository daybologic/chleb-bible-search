...
The latest release is version 3.0.1, which is available for download at the following sites:

  * [GitHub](https://github.com/daybologic/chleb-bible-search/archive/refs/tags/v3.0.1.tar.gz)
  * [SourceHut](https://git.sr.ht/~m6kvm/chleb-bible-search/archive/v3.0.1.tar.gz)
...
These files are a all bash shell files.  Start with [data/tests/1/template.sh](https://git.sr.ht/~m6kvm/chleb-bible-search/tree/v3.0.1/item/data/tests/1/template.sh) and copy this. The digit at the start represents the endpoint version.

You can test this by running [bin/maint/run-functional-tests.sh](https://git.sr.ht/~m6kvm/chleb-bible-search/tree/v3.0.1/item/bin/maint/run-functional-tests.sh) and specify the 1/name or run all the tests by specifying no parameters.
