...
The latest release is version 1.3.0, which is available for download at the following sites:

  * [GitHub](https://github.com/daybologic/chleb-bible-search/archive/refs/tags/v1.3.0.tar.gz)
  * [SourceHut](https://git.sr.ht/~m6kvm/chleb-bible-search/archive/v1.3.0.tar.gz)
...
```
sudo dpkg -i chleb-bible-search_1.3.0_all.deb
