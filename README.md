...
For API documentation, please use the documentation published at [SwaggerHub](https://app.swaggerhub.com/apis/M6KVM/chleb-bible-search/2.1.2)
...
The latest release is version 2.1.2, which is available for download at the following sites:

  * [GitHub](https://github.com/daybologic/chleb-bible-search/archive/refs/tags/v2.1.2.tar.gz)
  * [SourceHut](https://git.sr.ht/~m6kvm/chleb-bible-search/archive/v2.1.2.tar.gz)

The latest release is available as a Debian package from the following locations:

  * [GitHub](https://github.com/daybologic/chleb-bible-search/releases/download/v2.1.2/chleb-bible-search_2.1.2_all.deb)
  * [SourceHut](https://git.sr.ht/~m6kvm/chleb-bible-search/refs/v2.1.2)
...
```
sudo dpkg -i \
	chleb-bible-search_2.1.2_all.deb
	chleb-bible-search-core_2.1.2_all.deb
	chleb-bible-search-dict_2.1.2_all.deb
